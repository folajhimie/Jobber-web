...
const PartnerSection = () => {
  return (
    <section id='partner' className="px-6">
      <div className='rounded-3xl bg-gradient-to-b from-[#FFFFFF] to-[#F4F9FF] py-20'>
        <div className="container mx-auto">
          <div className="text-center mb-4">
            <h2 className="text-3xl font-bold mb-4 font-poppins">Trusted Partners Worldwide</h2>
            <p className='text-gray-500 font-poppins'>We're partners with countless major organisations around the globe</p>
          </div>
          <div className="mx-4">
