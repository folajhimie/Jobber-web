      ...
      <div className="px-4 mx-auto top-0 flex justify-between items-center">
        <div className="flex items-center">
          <Link className="link flex items-center" to="/">
            ...
            <span className="mt-1 mr-6">
              <img src={Icon} alt="jobber" width="140px" height="140px" />
            </span>
          </Link>
        </div>
        ...
        <div className="hidden gap-4 md:flex">
          ...
          <Link className="link flex items-center" to="/auth/login">
            <div className="bg-primary rounded-md py-2 px-10 text-white font-poppins flex items-center">
              Sign In
            </div>
          </Link>
          {/* <button >
          ...
          <Link className="link flex items-center" to="/auth/register">
            <div className="bg-white border border-teal-700 rounded-md py-2 px-10 text-primary font-poppins flex items-center">
              Sign Up
            </div>
          </Link>
          {/* <PrimaryButton>
