...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { token, status, message } = await register({
        username,
        password,
        email,
      }).unwrap();
        ...
        <div className="bg-gray-100 text-gray-500 shadow-lg hover:shadow-2xl w-9/12 overflow-hidden">
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              {errMsg && (
                <p className="mb-4 text-xs text-red-primary">{errMsg}</p>
              )}
              ...
              <form onSubmit={handleSubmit} method="POST">
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <label
                      htmlFor="text"
                      className="flex justify-start justify-items-start items-start mb-2 text-sm font-semibold text-gray-500 "
                    >
                      Username:
                    </label>
                    <div className="flex">
