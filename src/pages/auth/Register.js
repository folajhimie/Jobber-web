                            ...
                            <form onSubmit={handleSubmit} method="POST">
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="text" className="flex justify-start justify-items-start items-start mb-2 text-sm font-semibold text-gray-500 dark:text-white">Username:</label>
                                        <div className="flex">
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="email" className="flex justify-start justify-items-start items-start mb-2 text-sm font-semibold text-gray-500 dark:text-white">Email Address:</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-12">
                                        ...
                                        <label htmlFor="password" className="flex justify-start justify-items-start items-start mb-2 text-sm font-semibold text-gray-500 dark:text-white">Password:</label>
                                            ...
                                            >
                                                {
                                                    isToggle ?
                                                        <div className="cursor-pointer">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-gray-700 text-teal-600">
