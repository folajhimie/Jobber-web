          ...
          <div className="border border-gray-200 w-full bg-white rounded-lg  dark:border md:mt-0 sm:max-w-md xl:p-0  shadow-xl hover:shadow-2xl">
            <div className="flex justify-center w-full mt-6">
              <Link className="link flex items-center" to="/">
                <div className="m-1" style={{ width: "30px", height: "30px" }}>
                  <img src={Logo} alt="jobber" width="70px" height="70px" />
                </div>
                <span className="mt-1 mr-6">
                  <img src={Icon} alt="jobber" width="120px" height="120px" />
                </span>
              </Link>
            </div>
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p className="mt-2 text-center text-sm text-gray-600">
                ...
                <Link
                  to="#"
                  className="text-sm font-medium text-teal-700 dark:text-primary-500"
                >
              ...
              >
                <div className="d-flex justify-start">
                  <label
                    htmlFor="email"
                    className="flex justify-start justify-items-start items-start mb-2 text-sm font-medium text-gray-900 "
                  >
                    Email Address:
                  </label>
                  <div className="flex">
                  ...
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input
                        ...
                        type="checkbox"
                        className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-teal-300 dark:bg-teal-700 dark:border-teal-600 dark:focus:ring-teal-600 dark:ring-offset-teal-800"
                        required=""
                      />
                    </div>
                ...
                <div>
                  ...
                  <div className="flex justify-center gap-5 w-full ">
                    <button
                      type="submit"
                      className="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-50 hover:bg-gray-50 text-sm text-gray-500 p-3  rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500"
                    >
                      <svg
                        className="w-4 mr-2"
                        viewBox="0 0 24 24"
                    ...
                    <button
                      type="submit"
                      className="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-50 hover:bg-gray-50 text-sm text-gray-500 p-3 rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500 px-"
                    >
                      <svg
                        className="w-6 mr-2"
                        xmlns="http://www.w3.org/2000/svg"
